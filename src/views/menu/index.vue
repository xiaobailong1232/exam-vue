<template>
  <div class="app-container">
    ...
    <!-- 弹出层：创建菜单 start -->
    <el-dialog title="创建菜单" :visible.sync="form.show" :width="'400px'">
      <el-form :model="form.data" :label-width="'100px'">
        ...
        <el-form-item label="URI">
          <el-input v-model="form.data.uri" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog :title="edit.status ? '编辑' : '详情'" :visible.sync="edit.show">
      <el-form :model="edit.data" :label-width="'120px'">
        ...
        <el-form-item label="URI">
          <el-input v-model="edit.data.uri" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      initFetch() {
        ...
        this.loading = true;
        getMenuListFromApi(this.search).then(response => {
      ...
      addItem() {
        ...
        addMenuItemToApi(this.form.data).then(response => {
      ...
      deleteItem(row) {
        ...
        .then(() => deleteMenuItemToApi(row.id))
        .then(response => {
