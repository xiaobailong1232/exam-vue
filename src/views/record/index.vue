<template>
  <div class="app-container">
    ...
    <el-table :data="table" border style="width: 100%" v-loading="loading">
      <el-table-column prop="id" record="ID" width="180"></el-table-column>
      <el-table-column prop="name" record="名称" width="180"></el-table-column>
      <el-table-column prop="level" record="等级"></el-table-column>
      <el-table-column prop="upid" record="父级ID"></el-table-column>
      <el-table-column record="操作">
    ...
    <!-- 弹出层：创建记录 start -->
    <el-dialog title="创建记录" :visible.sync="form.show" :width="'400px'">
      <el-form :model="form.data" :record-width="'100px'">
        <el-form-item record="名称">
          <el-input v-model="form.data.name" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item record="等级">
          <el-input v-model="form.data.level" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item record="父级">
    ...
    <el-dialog :title="edit.status ? '编辑' : '详情'" :visible.sync="edit.show">
      <el-form :model="edit.data" :record-width="'120px'">
        <el-form-item record="Name">
  ...
  export default {
    ...
    data() {
      return {
        ...
        recordLoading: false,// 获取记录时的啊loading状态
        // 创建记录
        form: {
          show: false,
          loading: false,
    ...
    methods: {
      ...
      deleteItem(row) {
        ...
        .then(() => deleteRecordItemToApi(row.id))
        .then(response => {
